...
namespace FestivalAppv2.Data
{
    public class ArtiestRepository
    {
        ...
        public ArtiestRepository(string databaseWachtwoord)
        {
        ...
        public List<Artiest> GetAlleArtiesten()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                while (reader.Read())
                {
                    //Hier haal ik de gegevens uit de database rij
        ...
        {
            //Controleert of naam en genre zijn ingevuld
            if (artiest.GetNaam() == "" || artiest.GetGenre() == "")
            {
                Console.WriteLine("Naam en genre mogen niet leeg zijn.");
                return;
            }
        ...
        public void WijzigArtiest(Artiest artiest)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                //Query uitvoeren en controleren of er echt iets is aangepast
                int aantalRijenAangepast = command.ExecuteNonQuery();

                if (aantalRijenAangepast == 0)
                {
                    Console.WriteLine("Geen artiest gevonden met dit ID.");
                }
                else
                {
        ...
        public void VerwijderArtiest(int artiestId)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                //Verwijder optredens van het artiest
